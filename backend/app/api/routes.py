...
async def get_defects(
    ...
    # Debug: Print first defect type to see what we're dealing with
    if defects:
        print(f"First defect department type: {type(defects[0].department)}")
        print(f"First defect department value: {defects[0].department}")
